...
public class SwipeListView extends ListView{
    ...
    private int mRightViewWidth = 170;

    // private boolean mIsInAnimation = false;
    private final static int mDuration = 100;

    private final static int mDurationStep = 10;
     ...
     * 瞬间隐藏右边的布局
     */
    public void forceCloseOpenedItem(){
    	if(mPreItemView == null)
    		return;
    	
        Message msg = new ForceCloseHanlder().obtainMessage();
     ...
     *
     */
    private class ForceCloseHanlder extends Handler{
    	@Override
    	public void handleMessage(Message msg) {
    		super.handleMessage(msg);
