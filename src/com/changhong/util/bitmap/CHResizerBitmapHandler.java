...
public class CHResizerBitmapHandler extends CHProcessBitmapHandler
{
	 ...
	 * @param imageHeight
	 */
	public CHResizerBitmapHandler(Context context, int imageWidth,
			int imageHeight)
	{
	 ...
	 * @param imageSize
	 */
	public CHResizerBitmapHandler(Context context, int imageSize)
	{
		mResources = context.getResources();
