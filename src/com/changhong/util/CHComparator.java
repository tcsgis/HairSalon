...
import com.changhong.annotation.CHCompareAnnotation;
 ...
 * @version V1.0
 */
public class CHComparator<T> implements Comparator<T>
{
	/** 升序排列 */
	 ...
	 *            排序规则
	 */
	public CHComparator(int sortType)
	{
	 ...
	 *            排序标识
	 */
	public CHComparator(int sortType, int sortFlag)
	{
		this.sortType = sortType;
			...
			IllegalAccessException
	{
		...
		if (fields != null && fields.length > 0)
		{
			...
			{
				if (field.isAnnotationPresent(CHCompareAnnotation.class))
				{
					CHCompareAnnotation taCompareInject = field
							.getAnnotation(CHCompareAnnotation.class);
