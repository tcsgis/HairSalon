...
/**
 * @Title CHPreferenceConfig
 * @Package com.changhong.util.config
 * @Description CHPreferenceConfig是ThinkAndroid的Preference类型配置文件操作类
 * @version V1.0
 */
public class CHPreferenceConfig implements CHIConfig
{
	private static CHIConfig mPreferenceConfig;
	private Context mContext;
	private Editor edit;
	private SharedPreferences mSharedPreferences;
	private String filename = "chandroid";
	private Boolean isLoad = false;

	private CHPreferenceConfig(Context context)
	{
	 ...
	 * @return
	 */
	public static CHIConfig getPreferenceConfig(Context context)
	{
		if (mPreferenceConfig == null)
		{
			mPreferenceConfig = new CHPreferenceConfig(context);
		}
