 ...
 * @Title LayoutLoader
 * @Package com.changhong.util.layoutloader
 * @Description LayoutLoader是获取系统资源加载器
 * @version V1.0
 */
public class LayoutLoader implements ILayoutLoader
{
	...
	public int getLayoutID(String resIDName) throws NameNotFoundException,
			...
			IllegalAccessException, CHNoSuchNameLayoutException
	{
	...
	{
		//自动化编译时可选择修改packageName, 造成资源的packageName与包名不符, 不能反射
		return mContext.getResources().getIdentifier(resIDName, type, mContext.getPackageName());
//		String packageName;
